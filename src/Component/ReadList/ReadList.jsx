    ...
    <div className="my-5">
      <div className="flex flex-col lg:flex-row p-6 rounded-2xl border border-neutral-900 border-opacity-20 gap-6">
        ...
        <div className="space-y-4">
          <h2 className="text-neutral-900 text-2xl font-bold">{bookName}</h2>
          ...
          <div className="flex gap-3 lg:flex-row flex-col ">
            ...
            <NavLink to={`/bookDetails/${bookId}`}><button className="px-5 py-2.5 bg-[#23BE0A] rounded-3xl text-white ">View Details</button></NavLink>
            </div>
